...
func NewGormUserStore(db *gorm.DB) identra.UserStore {
...
func (r *gormUserStore) Create(ctx context.Context, user *identra.UserModel) error {
...
func (r *gormUserStore) GetByID(ctx context.Context, id string) (*identra.UserModel, error) {
...
func (r *gormUserStore) GetByEmail(ctx context.Context, email string) (*identra.UserModel, error) {
	var record userRecord
...
func (r *gormUserStore) Update(ctx context.Context, user *identra.UserModel) error {
	record := userRecordFromDomain(user)
...
func (r *gormUserStore) List(ctx context.Context, offset, limit int) ([]*identra.UserModel, error) {
