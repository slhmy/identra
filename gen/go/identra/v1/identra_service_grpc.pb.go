...
const (
	...
	IdentraService_RevokeRefreshToken_FullMethodName       = "/identra.v1.IdentraService/RevokeRefreshToken"
...
func (c *identraServiceClient) RevokeRefreshToken(ctx context.Context, in *RevokeRefreshTokenRequest, opts ...grpc.CallOption) (*RevokeRefreshTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RevokeRefreshTokenResponse)
	err := c.cc.Invoke(ctx, IdentraService_RevokeRefreshToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIdentraServiceServer) BindUserByOAuth(context.Context, *BindUserByOAuthRequest) (*BindUserByOAuthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BindUserByOAuth not implemented")
}
...
func (UnimplementedIdentraServiceServer) RevokeRefreshToken(context.Context, *RevokeRefreshTokenRequest) (*RevokeRefreshTokenResponse, error) {
...
func (UnimplementedIdentraServiceServer) GetCurrentUserLoginInfo(context.Context, *GetCurrentUserLoginInfoRequest) (*GetCurrentUserLoginInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCurrentUserLoginInfo not implemented")
}
...
func RegisterIdentraServiceServer(s grpc.ServiceRegistrar, srv IdentraServiceServer) {
	// If the following call pancis, it indicates UnimplementedIdentraServiceServer was
...
func _IdentraService_RevokeRefreshToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeRefreshTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentraServiceServer).RevokeRefreshToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IdentraService_RevokeRefreshToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentraServiceServer).RevokeRefreshToken(ctx, req.(*RevokeRefreshTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IdentraService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _IdentraService_RevokeRefreshToken_Handler,
		},
		{
